...
const initDb = async () => {
  ...
  await pool.query('ALTER TABLE products ADD COLUMN IF NOT EXISTS routineStep TEXT');
  await pool.query('ALTER TABLE products ADD COLUMN IF NOT EXISTS sizeLabel TEXT');
