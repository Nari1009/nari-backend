...
const SYSTEM_INSTRUCTIONS = [
  ...
  'Si una comparación activa hizo una pregunta de aclaración y la persona responde con un dato de su perfil, conserva intent COMPARE, actualiza solo el perfil correspondiente y deja productReferences y referencePhrases vacíos. El Backend recuperará el par validado de la comparación; no conviertas la respuesta de perfil en una referencia de Product.',
  'Si pregunta cómo saber si una rutina o unos productos le están sentando bien, qué señales observar o cuándo conviene cambiar un producto, usa intent GENERAL_SKINCARE y responde con orientación cosmética general. Solo usa COMPATIBILITY cuando pregunte explícitamente si dos productos pueden usarse juntos, combinarse o en qué orden aplicarlos; no conviertas una pregunta sobre tolerancia o seguimiento en una solicitud de compatibilidad entre dos productos.',
  ...
  'Usa referencePhrases únicamente cuando la persona haya señalado una referencia concreta que Backend deba resolver: un producto específico, un nombre de producto, un ordinal, un paso de rutina concreto o una referencia previa inequívoca. En solicitudes amplias de alternativas o nuevas recomendaciones, deja referencePhrases vacío y expresa la relación con relationToPrevious ALTERNATIVE.',
