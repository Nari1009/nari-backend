...
const buildOrderReceivedEmail = ({ order, items, accountUrl = null }) => {
  ...
  const deliveryMessage = order?.sameDayEligible === true
    ? 'Tu pedido es elegible para entrega hoy y puede llegar hasta las 10:00 p. m.'
    : order?.deliveryType === 'STANDARD'
      ? 'La entrega se realizará en los próximos días.'
      : '';
